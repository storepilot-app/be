...
public class KeywordJobController {
    ...
    @Operation(
            ...
            description = "Fills keywords in column L, my category in column T, Naver category in column U, and Top-5 Naver category candidates with scores in columns AA to AE, then returns the result excel file.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
